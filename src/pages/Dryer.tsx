import dryerTechImg from "../assets/dryer/dryerproblems.png";
import dryerRoomImg from "../assets/dryer/dryerrepair.png";
import "../styles/pages/dryer.scss";
  ...
  return (
    <>
      <section className="intro-section">
        <div className="container">
          ...
          <div className="intro-section__content">
            <h1 className="intro-section__title">Dryer Repair Services</h1>
      ...
      <section className="problems">
        <div className="container problems__grid">
          <div
            className="problems__image"
            style={{ backgroundImage: `url(${dryerTechImg})` }}
          ></div>
          ...
          <div className="problems__content">
            ...
            <p className="problems__description">
              We fix all common dryer issues, from simple repairs to complex
              failures.
            </p>
            ...
            <div className="problems__list">
              <ul>
                ...
                <li>Dryer won’t start</li>
                <li>Takes too long to dry</li>
              </ul>

              <ul>
                <li>Loud or unusual noises</li>
                <li>Shuts off mid-cycle</li>
                <li>Door won’t close</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="container trust__grid">
          <div className="trust__content"> 
            <h2 className="trust__title">
              Why Homeowners Trust Us for Dryer Repair
            </h2>

            <div className="trust__features">
              <div className="trust__feature">
              ...
              <div className="trust__feature">
                Fast scheduling, same-day service available
              </div>

              <div className="trust__feature">Warranty on parts and labor</div>
            </div>

            <div className="trust__cta">
              <p className="trust__cta-title">Dryer not working?</p>

              <p className="trust__cta-text">We're ready to help today.</p>
          ...
          <div
            ...
            style={{ backgroundImage: `url(${dryerRoomImg})` }}
          ></div>
        </div>
      </section>
      <section className="faq-section">
        <div className="container faq-section__grid">
          ...
          <div className="faq-section__right">
            {questions.map((el, i) => (
              <details open={i == 0 ? true : false} className="faq-section__item">
                <summary>
        ...
        <div className="container">
          ...
          <div className="features__grid">
            {features.map((feature, index) => (
              <div key={index} className="features__feature">
                <h3 className="features__feature-title">{feature.title}</h3>
